...
import { HRDepartmentService } from "../../../../services/hr.department.service";
...
export async function GET(req: Request) {
  try {
    ...
    const result = await HRDepartmentService.listDepartments({
      supabase,
      companyId,
    });
...
export async function POST(req: Request) {
  try {
    ...
    const result = await HRDepartmentService.createDepartment({
      supabase,
...
export async function PATCH(req: Request) {
  try {
    ...
    const result = await HRDepartmentService.updateDepartment({
      supabase,
      payload: { ...body, companyId },
    });
...
export async function DELETE(req: Request) {
  try {
    ...
    const result = await HRDepartmentService.deleteDepartment({
      supabase,
      companyId,
      id
    });
