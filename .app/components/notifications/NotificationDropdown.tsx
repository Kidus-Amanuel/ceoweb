      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border/40 bg-muted/20">
        <div className="flex items-center gap-2">
          ...
          <span className={cn(
            ...
            notifications.filter(n => !n.is_read).length > 0 ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
          )}>
      ...
      <div className="flex-1 overflow-hidden relative">
        ...
        {notifications.length > 0 ? (
          ...
          <div className="h-full flex flex-col items-center justify-center p-8 opacity-40">
            ...
            <p className="text-xs text-center mt-1">We&apos;ll let you know when something important happens.</p>
          </div>
        )}
      </div>
