Feature Overview
  ...
  <CrmWorkspaceErrorBoundary>
    ...
    {/* All tabs share one error boundary */}
  </CrmWorkspaceErrorBoundary>
  ...
  staleTime: 10 * 60 * 1000, // Extract to COLUMN_CACHE_TTL
  ...
  const COLUMN_CACHE_TTL = 10 * 60 * 1000;
  ...
  2. Add staleTime: 5 * 60 * 1000 (cache for 5 minutes)
